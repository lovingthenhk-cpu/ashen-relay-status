...
更新日: 2026-09-24。**企画上42パターン**。内訳は現行packに入っているModとAshen Relayの部品を組む **C01〜C22の22件**（機械確認1、一部稼働10、計画11）、未導入Modの部品を隔離試験して採用可否を決める **X01〜X20の20件**（全件隔離試験待ち）。これは完成数でも、42種類のModや42棟の建物を入れる約束でもない。R-27W3はユーザー指示により未着手のまま。
